...
def main(args):
    ...
    initial_sample_size = int(args.sample_size * 2)  # Double the sample size as a precaution
    sampled_indices = random.sample(range(len(dataset["train"])), initial_sample_size)
